...
id = canvas.create_rectangle((10,85,30,105),fill="black",tags=('palette','paletteblack'))
canvas.tag_bind(id,"<Button-1>",lambda x: setColor("black"))
id = canvas.create_rectangle((10,110,30,130),fill="orange",tags=('palette','paletteorange'))
canvas.tag_bind(id,"<Button-1>",lambda x: setColor("orange"))
canvas.itemconfigure('palette', width=10)
root.mainloop()
